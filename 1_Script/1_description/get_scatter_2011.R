...
map_data_biv <- readRDS("0_input/map_data_COG2024_C_2011_biv.rds")
map_data <- readRDS("0_input/map_data_COG2024_C_2011.rds")
...
Label.S <- c("Low_edu_prop" = "Low education", "Medium_edu_prop" = "Medium education", "High_edu_prop" = "High education", 
             ...
             "D121" = "1er Décile","Q211" = "Médiane","D921" = "9e Décile","RD" = "Rapport interdécile D9/D1")
...
plot.fn <- function(plot.data, polluant, sociale){
  ...
  ggsave(paste0(output.file,polluant, "by_u_weighted_2011.png" ), plot, width = 10, height = 5, dpi = 250)
  ggsave(paste0(output.file,polluant, "All_weighted_2011.png" ), plot.all, width = 5, height = 5, dpi = 250)
