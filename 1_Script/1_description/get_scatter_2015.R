...
plot.fn <- function(plot.data, polluant, sociale){
  ...
  ggsave(paste0(output.file,polluant, "by_u_weighted_2015.png" ), plot, width = 10, height = 5, dpi = 250)
  ggsave(paste0(output.file,polluant, "All_weighted_2015.png" ), plot.all, width = 5, height = 5, dpi = 250)
