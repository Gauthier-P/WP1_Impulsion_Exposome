...
sociales <-c("Low_edu_prop", "Medium_edu_prop", "High_edu_prop","Prop_Immigre","D121","D221","D921")
...
wb <- createWorkbook()
Variable <- c(Polluants,Seuil,  "High_edu_prop", "Q211")
...
saveWorkbook(wb, "2_Results/Description/table_comp_raw_2011.xlsx", overwrite = T)
