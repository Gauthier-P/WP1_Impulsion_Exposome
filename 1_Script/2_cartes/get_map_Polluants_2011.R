...
# #   inner_join(Merged_2011, by = "CODGEO")
# 
...
map_NO2_2011 <- ggplot(map_data_2011) +
...
ggsave("2_results/Map/2011/Air_pollution/map_NO2_2011.png", plots$MOY.NO2, width = 5,height = 5)
ggsave("2_results/Map/2011/Air_pollution/map_O3_2011.png", plots$MOY.O3, width = 5,height = 5)
ggsave("2_results/Map/2011/Air_pollution/map_PM25_2011.png", plots$MOY.PM25, width = 5,height = 5)
ggsave("2_results/Map/2011/Air_pollution/map_PM10_2011.png", plots$MOY.PM10, width = 5,height = 5)
...
map_combined <-
  ...
  plot_annotation(
    title = "Moyenne annuelle des polluants atmosphériques par commune (2011)",
    subtitle = "COG 2024",
...
#
ggsave("2_results/Map/2011/Air_pollution/map_combined.png", map_combined, width = 10,height = 10)
