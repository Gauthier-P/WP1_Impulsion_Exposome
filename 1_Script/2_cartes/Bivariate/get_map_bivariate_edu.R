...
legend_low  <- make_legend("Tercile low éducation →", "Tercile")
legend_high <- make_legend("Tercile high éducation →", "Tercile")
...
for(i in seq_len(nrow(titles))){
  ...
  legend_use <- if(grepl("Low", titles$var[i])) legend_low else legend_high
...
################################################################################
legend_low  <- make_legend("Tercile low éducation →", "Seuil")
legend_high <- make_legend("Tercile high éducation →", "Seuil")
