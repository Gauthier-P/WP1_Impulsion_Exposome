...
# #   inner_join(Merged_2021, by = "CODGEO")
# 
...
map_NO2_2021 <- ggplot(map_data_2021) +
...
ggsave("2_results/Map/2021/Air_pollution/map_NO2_2021.png", plots$MOY.NO2, width = 5,height = 5)
ggsave("2_results/Map/2021/Air_pollution/map_O3_2021.png", plots$MOY.O3, width = 5,height = 5)
ggsave("2_results/Map/2021/Air_pollution/map_PM25_2021.png", plots$MOY.PM25, width = 5,height = 5)
ggsave("2_results/Map/2021/Air_pollution/map_PM10_2021.png", plots$MOY.PM10, width = 5,height = 5)
...
#
ggsave("2_results/Map/2021/Air_pollution/map_combined.png", map_combined, width = 10,height = 10)
